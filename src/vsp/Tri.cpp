...
//			t0->ComputeQual(), t1->ComputeQual(), t->ComputeQual() );
		...
		Tri* badtri = t;
		if ( t0->Area() < badtri->Area() ) t0 = badtri;
		if ( t1->Area() < badtri->Area() ) t1 = badtri;
...
{
	if ( n0 == curr_node ) n0 = replace_node;
	else if ( n1 == curr_node ) n1 = replace_node;
	else assert(0);
}
...
{
	if ( e0->n0 == nn0 && e0->n1 == nn1 )	return e0;
	if ( e0->n0 == nn1 && e0->n1 == nn0 )	return e0;
	if ( e1->n0 == nn0 && e1->n1 == nn1 )	return e1;
	if ( e1->n0 == nn1 && e1->n1 == nn0 )	return e1;
	if ( e2->n0 == nn0 && e2->n1 == nn1 )	return e2;
	if ( e2->n0 == nn1 && e2->n1 == nn0 )	return e2;
...
{
	if ( e0->n0 != node_ptr && e0->n1 != node_ptr )	return e0;
	if ( e1->n0 != node_ptr && e1->n1 != node_ptr )	return e1;
	if ( e2->n0 != node_ptr && e2->n1 != node_ptr )	return e2;
...
void Tri::ReplaceNode( Node* curr_node, Node* replace_node )
{
	...
	else if ( n2 == curr_node ) n2 = replace_node;
	else assert(0);
}

void Tri::ReplaceEdge( Edge* curr_edge, Edge* replace_edge )
{
	if ( e0 == curr_edge ) e0 = replace_edge;
	else if ( e1 == curr_edge ) e1 = replace_edge;
	else if ( e2 == curr_edge ) e2 = replace_edge;
	else assert(0);
}
...
{
	if      ( n0 == a && n1 == b ) return n2;
	else if ( n0 == b && n1 == a ) return n2;
	else if ( n1 == a && n2 == b ) return n0;
	else if ( n1 == b && n2 == a ) return n0;
	else if ( n0 == a && n2 == b ) return n1;
	else if ( n0 == b && n2 == a ) return n1;
	else assert(0);
...
void Tri::LoadAdjTris( int num_levels, set< Tri* > & triSet )
{
	...
	{
		t = e0->OtherTri( this );
		if ( t )	t->LoadAdjTris( num_levels, triSet );
	}
	if ( !e1->border )
	{
		t = e1->OtherTri( this );
