...
// #include <libxml/nanohttp.h> // Removed in libxml2 2.14, see CheckVersionNumber
...
// The online version check and usage report below are disabled.  They used
// libxml2's nanoHTTP client, which libxml2 2.14 removed, and plain HTTP,
// while openvsp.org now redirects to HTTPS and no longer serves the version
// page.  Kept for reference until they are reimplemented.
//
...
int main( int argc, char** argv )
{
    ...
    // Disabled, see CheckVersionNumber above.
