...
void ScriptMgrSingleton::RegisterEnums( asIScriptEngine* se )
{
  ...
  ///*! Enum for identifying the atmospheric model */)";
    ...
    assert( r >= 0 );
    r = se->RegisterEnumValue( "FEA_MATERIAL_TYPE", "FEA_ENG_ORTHO_TRANS_ISO", FEA_ENG_ORTHO_TRANS_ISO, "/*!< Orthotropic material with transverse isotropy assumed in engineering parameters */" );
    assert( r >= 0 );
    ...
    doc_struct.comment = "/*! Enum for OpenVSP screen types. */";

    r = se->RegisterEnum( "GUI_VSP_SCREEN", doc_struct );
    assert( r >= 0 );
    ...
    assert( r >= 0 );
    r = se->RegisterEnumValue( "GUI_VSP_SCREEN", "VSP_AIRFOIL_POINTS_EXPORT_SCREEN", VSP_AIRFOIL_POINTS_EXPORT_SCREEN, "/*!< Airfoil points screen */" );
    assert( r >= 0 );
    r = se->RegisterEnumValue( "GUI_VSP_SCREEN", "VSP_BACKGROUND_SCREEN", VSP_BACKGROUND_SCREEN, "/*!< Background control screen */" );
    assert( r >= 0 );
    r = se->RegisterEnumValue( "GUI_VSP_SCREEN", "VSP_BEM_OPTIONS_SCREEN", VSP_BEM_OPTIONS_SCREEN, "/*!< Blade element method options screen */" );
    assert( r >= 0 );
    r = se->RegisterEnumValue( "GUI_VSP_SCREEN", "VSP_CFD_MESH_SCREEN", VSP_CFD_MESH_SCREEN, "/*!< CFD Mesh screen */" );
    assert( r >= 0 );
    r = se->RegisterEnumValue( "GUI_VSP_SCREEN", "VSP_CLIPPING_SCREEN", VSP_CLIPPING_SCREEN, "/*!< Clipping screen */" );
    assert( r >= 0 );
    r = se->RegisterEnumValue( "GUI_VSP_SCREEN", "VSP_COMP_GEOM_SCREEN", VSP_COMP_GEOM_SCREEN, "/*!< CompGeom screen */" );
    assert( r >= 0 );
    r = se->RegisterEnumValue( "GUI_VSP_SCREEN", "VSP_COR_SCREEN", VSP_COR_SCREEN, "/*!< Center of rotation screen */" );
    assert( r >= 0 );
    r = se->RegisterEnumValue( "GUI_VSP_SCREEN", "VSP_CURVE_EDIT_SCREEN", VSP_CURVE_EDIT_SCREEN, "/*!< Curve edit screen */" );
    assert( r >= 0 );
    r = se->RegisterEnumValue( "GUI_VSP_SCREEN", "VSP_DEGEN_GEOM_SCREEN", VSP_DEGEN_GEOM_SCREEN, "/*!< Degen geom screen */" );
    assert( r >= 0 );
    r = se->RegisterEnumValue( "GUI_VSP_SCREEN", "VSP_DESIGN_VAR_SCREEN", VSP_DESIGN_VAR_SCREEN, "/*!< Design variables screen */" );
    assert( r >= 0 );
    r = se->RegisterEnumValue( "GUI_VSP_SCREEN", "VSP_DXF_OPTIONS_SCREEN", VSP_DXF_OPTIONS_SCREEN, "/*!< DXF options screen */" );
    assert( r >= 0 );
    r = se->RegisterEnumValue( "GUI_VSP_SCREEN", "VSP_EXPORT_SCREEN", VSP_EXPORT_SCREEN, "/*!< Export screen */" );
    assert( r >= 0 );
    r = se->RegisterEnumValue( "GUI_VSP_SCREEN", "VSP_FEA_PART_EDIT_SCREEN", VSP_FEA_PART_EDIT_SCREEN, "/*!< FEA Part edit screen */" );
    assert( r >= 0 );
    r = se->RegisterEnumValue( "GUI_VSP_SCREEN", "VSP_FEA_XSEC_SCREEN", VSP_FEA_XSEC_SCREEN, "/*!< FEA XSec screen */" );
    assert( r >= 0 );
    r = se->RegisterEnumValue( "GUI_VSP_SCREEN", "VSP_FIT_MODEL_SCREEN", VSP_FIT_MODEL_SCREEN, "/*!< Fit model screen */" );
    assert( r >= 0 );
    r = se->RegisterEnumValue( "GUI_VSP_SCREEN", "VSP_IGES_OPTIONS_SCREEN", VSP_IGES_OPTIONS_SCREEN, "/*!< IGES options screen */" );
    assert( r >= 0 );
    r = se->RegisterEnumValue( "GUI_VSP_SCREEN", "VSP_IGES_STRUCTURE_OPTIONS_SCREEN", VSP_IGES_STRUCTURE_OPTIONS_SCREEN, "/*!< IGES structure options screen */" );
    assert( r >= 0 );
    r = se->RegisterEnumValue( "GUI_VSP_SCREEN", "VSP_EXPORT_CUSTOM_SCRIPT", VSP_EXPORT_CUSTOM_SCRIPT, "/*!< Custom geom export screen */" );
    assert( r >= 0 );
    r = se->RegisterEnumValue( "GUI_VSP_SCREEN", "VSP_IMPORT_SCREEN", VSP_IMPORT_SCREEN, "/*!< Import screen */" );
    assert( r >= 0 );
    r = se->RegisterEnumValue( "GUI_VSP_SCREEN", "VSP_LIGHTING_SCREEN", VSP_LIGHTING_SCREEN, "/*!< Lighting screen */" );
    assert( r >= 0 );
    r = se->RegisterEnumValue( "GUI_VSP_SCREEN", "VSP_MANAGE_GEOM_SCREEN", VSP_MANAGE_GEOM_SCREEN, "/*!< Manage geom screen */" );
    assert( r >= 0 );
    r = se->RegisterEnumValue( "GUI_VSP_SCREEN", "VSP_MANAGE_TEXTURE_SCREEN", VSP_MANAGE_TEXTURE_SCREEN, "/*!< Texture mapping screen */" );
    assert( r >= 0 );
    r = se->RegisterEnumValue( "GUI_VSP_SCREEN", "VSP_MASS_PROP_SCREEN", VSP_MASS_PROP_SCREEN, "/*!< Mass properties screen */" );
    assert( r >= 0 );
    r = se->RegisterEnumValue( "GUI_VSP_SCREEN", "VSP_MATERIAL_EDIT_SCREEN", VSP_MATERIAL_EDIT_SCREEN, "/*!< Material edit screen */" );
    assert( r >= 0 );
    r = se->RegisterEnumValue( "GUI_VSP_SCREEN", "VSP_MEASURE_SCREEN", VSP_MEASURE_SCREEN, "/*!< Measure screen */" );
    assert( r >= 0 );
    r = se->RegisterEnumValue( "GUI_VSP_SCREEN", "VSP_SNAP_TO_SCREEN", VSP_SNAP_TO_SCREEN, "/*!< Snap to screen */" );
    assert( r >= 0 );
    r = se->RegisterEnumValue( "GUI_VSP_SCREEN", "VSP_PARASITE_DRAG_SCREEN", VSP_PARASITE_DRAG_SCREEN, "/*!< Parasite drg screen */" );
    assert( r >= 0 );
    r = se->RegisterEnumValue( "GUI_VSP_SCREEN", "VSP_PARM_DEBUG_SCREEN", VSP_PARM_DEBUG_SCREEN, "/*!< Parameter debug screen */" );
    assert( r >= 0 );
    r = se->RegisterEnumValue( "GUI_VSP_SCREEN", "VSP_PARM_LINK_SCREEN", VSP_PARM_LINK_SCREEN, "/*!< Parameter linking screen */" );
    assert( r >= 0 );
    ...
    assert( r >= 0 );
    r = se->RegisterEnumValue( "GUI_VSP_SCREEN", "VSP_PSLICE_SCREEN", VSP_PSLICE_SCREEN, "/*!< Planar slicing screen */" );
    assert( r >= 0 );
    r = se->RegisterEnumValue( "GUI_VSP_SCREEN", "VSP_SCREENSHOT_SCREEN", VSP_SCREENSHOT_SCREEN, "/*!< Screenshot screen */" );
    assert( r >= 0 );
    r = se->RegisterEnumValue( "GUI_VSP_SCREEN", "VSP_SELECT_FILE_SCREEN", VSP_SELECT_FILE_SCREEN, "/*!< Select file screen */" );
    assert( r >= 0 );
    r = se->RegisterEnumValue( "GUI_VSP_SCREEN", "VSP_SET_EDITOR_SCREEN", VSP_SET_EDITOR_SCREEN, "/*!< Set editor screen */" );
    assert( r >= 0 );
    r = se->RegisterEnumValue( "GUI_VSP_SCREEN", "VSP_STEP_OPTIONS_SCREEN", VSP_STEP_OPTIONS_SCREEN, "/*!< STEP options screen */" );
    assert( r >= 0 );
    r = se->RegisterEnumValue( "GUI_VSP_SCREEN", "VSP_STEP_STRUCTURE_OPTIONS_SCREEN", VSP_STEP_STRUCTURE_OPTIONS_SCREEN, "/*!< STEP structure options screen */" );
    assert( r >= 0 );
    r = se->RegisterEnumValue( "GUI_VSP_SCREEN", "VSP_STL_OPTIONS_SCREEN", VSP_STL_OPTIONS_SCREEN, "/*!< STL options screen */" );
    assert( r >= 0 );
    r = se->RegisterEnumValue( "GUI_VSP_SCREEN", "VSP_STRUCT_SCREEN", VSP_STRUCT_SCREEN, "/*!< Structure definition screen */" );
    assert( r >= 0 );
    r = se->RegisterEnumValue( "GUI_VSP_SCREEN", "VSP_STRUCT_ASSEMBLY_SCREEN", VSP_STRUCT_ASSEMBLY_SCREEN, "/*!< Structure assembly screen */" );
    assert( r >= 0 );
    r = se->RegisterEnumValue( "GUI_VSP_SCREEN", "VSP_SURFACE_INTERSECTION_SCREEN", VSP_SURFACE_INTERSECTION_SCREEN, "/*!< Surface intersection screen */" );
    assert( r >= 0 );
    r = se->RegisterEnumValue( "GUI_VSP_SCREEN", "VSP_SVG_OPTIONS_SCREEN", VSP_SVG_OPTIONS_SCREEN, "/*!< SVG options screen */" );
    assert( r >= 0 );
    r = se->RegisterEnumValue( "GUI_VSP_SCREEN", "VSP_USER_PARM_SCREEN", VSP_USER_PARM_SCREEN, "/*!< User parameter screen */" );
    assert( r >= 0 );
    r = se->RegisterEnumValue( "GUI_VSP_SCREEN", "VSP_VAR_PRESET_SCREEN", VSP_VAR_PRESET_SCREEN, "/*!< Variable presets screen */" );
    assert( r >= 0 );
    r = se->RegisterEnumValue( "GUI_VSP_SCREEN", "VSP_VIEW_SCREEN", VSP_VIEW_SCREEN, "/*!< Adjust viewpoint screen */" );
    assert( r >= 0 );
    r = se->RegisterEnumValue( "GUI_VSP_SCREEN", "VSP_VSPAERO_PLOT_SCREEN", VSP_VSPAERO_PLOT_SCREEN, "/*!< VSPAERO results manager screen */" );
    assert( r >= 0 );
    r = se->RegisterEnumValue( "GUI_VSP_SCREEN", "VSP_VSPAERO_SCREEN", VSP_VSPAERO_SCREEN, "/*!< VSPAERO screen */" );
    assert( r >= 0 );
    r = se->RegisterEnumValue( "GUI_VSP_SCREEN", "VSP_XSEC_SCREEN", VSP_XSEC_SCREEN, "/*!< XSec screen */" );
    assert( r >= 0 );
    r = se->RegisterEnumValue( "GUI_VSP_SCREEN", "VSP_WAVEDRAG_SCREEN", VSP_WAVEDRAG_SCREEN, "/*!< Wave drag screen */" );
    assert( r >= 0 );
