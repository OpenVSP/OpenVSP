...
//  enum { SLICE_PLANAR, SLICE_AWAVE };
    ...
    */
    ...
    static double MakeSlices( vector<TMesh*> &tmv, const BndBox & bbox, int numSlices, int swdir, vector < double > &slicevec, bool mpslice = true, bool tesselate = true, bool autoBounds = true, double start = 0, double end = 0, int slctype = vsp::CFD_STRUCTURE );
    ...
    virtual void AddHalfBox( const string &id );
