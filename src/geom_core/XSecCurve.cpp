...
SuperXSec::SuperXSec() : XSecCurve() {
    ...
    m_M.Init("Super_M", m_GroupName, this, 2.0, 0.25, 5.0);
    m_M.SetDescript("Generalized Super Ellipse M Exponent for Top Half");
    m_N.Init("Super_N", m_GroupName, this, 2.0, 0.25, 5.0);
    m_N.SetDescript("Generalized Super Ellipse N Exponent for Top Half");
...
RoundedRectXSec::RoundedRectXSec() : XSecCurve() {
    ...
    m_TopBotSym.Init("RoundRect_TopBotSym", m_GroupName, this, 1, 0, 1, true);
}
