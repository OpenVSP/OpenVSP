...
public:
    ...
    Parm m_Offset;                  // Offset to Clearance Surface
...
protected:
    ...
    virtual double AdjustForSurfaceDist( const VspSurf & surf, const ClearanceSpine & spine, double u, double offset, bool backward_flag );
