...
IF( VSP_USE_SYSTEM_LIBXML2 )
    FIND_PACKAGE(LibXml2 REQUIRED)
ELSE()
    # The bundled static libxml2's package config supplies its link
    # dependencies, and LIBXML_STATIC in LIBXML2_DEFINITIONS on Windows.
    FIND_PACKAGE(LibXml2 CONFIG REQUIRED)
    ADD_DEFINITIONS( ${LIBXML2_DEFINITIONS} )
ENDIF()

SET( CMAKE_PREFIX_PATH ${OPENABF_INSTALL_DIR} ${ORIG_CMAKE_PREFIX_PATH} )
