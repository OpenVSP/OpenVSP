...
SOLVER_CXXFLAGS = -std=c++11 -O3 -funroll-loops -funroll-all-loops -Wno-unused -Wno-format-security -Wno-format-overflow
SOLVER_LDFLAGS =
ARFLAGS = rcs
...
# TODO: add examples of what's required for Mac?
