...
ShaderRepo::~ShaderRepo()
{
    for( int i = 0; i < ( int )_shaderRepo.size(); i++ )
    {
        ...
        _shaderRepo[i].shaderPtr = nullptr;
    }
}
...
Shader * ShaderRepo::getShader( VSPShaderEnum shaderType )
{
    ...
    case SHADER_TEXTURE01:
        if( _shaderRepo[SHADER_TEXTURE01].shaderPtr == nullptr )
        {
    ...
    case SHADER_TEXTURE01_NO_LIGHTING:
        if( _shaderRepo[SHADER_TEXTURE01_NO_LIGHTING].shaderPtr == nullptr )
        {
    ...
    case SHADER_MULTITEXTURE02_BLEND:
        if( _shaderRepo[SHADER_MULTITEXTURE02_BLEND].shaderPtr == nullptr )
        {
    ...
    case SHADER_MULTITEXTURE02_LAYERED:
        if( _shaderRepo[SHADER_MULTITEXTURE02_LAYERED].shaderPtr == nullptr )
        {
    ...
    case SHADER_MULTITEXTURE03_BLEND:
        if( _shaderRepo[SHADER_MULTITEXTURE03_BLEND].shaderPtr == nullptr )
        {
    ...
    case SHADER_MULTITEXTURE03_LAYERED:
        if( _shaderRepo[SHADER_MULTITEXTURE03_LAYERED].shaderPtr == nullptr )
        {
    ...
    case SHADER_MULTITEXTURE04_BLEND:
        if( _shaderRepo[SHADER_MULTITEXTURE04_BLEND].shaderPtr == nullptr )
        {
    ...
    case SHADER_MULTITEXTURE04_LAYERED:
        if( _shaderRepo[SHADER_MULTITEXTURE04_LAYERED].shaderPtr == nullptr )
        {
    ...
    case SHADER_MULTITEXTURE05_BLEND:
        if( _shaderRepo[SHADER_MULTITEXTURE05_BLEND].shaderPtr == nullptr )
        {
    ...
    case SHADER_MULTITEXTURE05_LAYERED:
        if( _shaderRepo[SHADER_MULTITEXTURE05_LAYERED].shaderPtr == nullptr )
        {
    ...
    case SHADER_MULTITEXTURE06_BLEND:
        if( _shaderRepo[SHADER_MULTITEXTURE06_BLEND].shaderPtr == nullptr )
        {
    ...
    case SHADER_MULTITEXTURE06_LAYERED:
        if( _shaderRepo[SHADER_MULTITEXTURE06_LAYERED].shaderPtr == nullptr )
        {
    ...
    case SHADER_MULTITEXTURE07_BLEND:
        if( _shaderRepo[SHADER_MULTITEXTURE07_BLEND].shaderPtr == nullptr )
        {
    ...
    case SHADER_MULTITEXTURE07_LAYERED:
        if( _shaderRepo[SHADER_MULTITEXTURE07_LAYERED].shaderPtr == nullptr )
        {
    ...
    case SHADER_MULTITEXTURE08_BLEND:
        if( _shaderRepo[SHADER_MULTITEXTURE08_BLEND].shaderPtr == nullptr )
        {
    ...
    case SHADER_MULTITEXTURE08_LAYERED:
        if( _shaderRepo[SHADER_MULTITEXTURE08_LAYERED].shaderPtr == nullptr )
        {
