...
void NerfManageGeomScreen::GetCollIDs( vector < string > &collIDVec )
{
...
void NerfManageGeomScreen::MakeGeomCache()
{
    vector < string > geom_vec = m_VehiclePtr->GetGeomVec();
...
void NerfManageGeomScreen::ClearGeomCache()
{
    m_GeomPtrVec.clear();
    m_GeomPtrMap.clear();
}
...
void NerfManageGeomScreen::CloseCallBack( Fl_Widget *w )
{
    m_ScreenMgr->SetUpdateFlag( true );
    Hide();
}
