...
// SuperConeScreen.h: UI for SuperCone Geom
// Rob McDonald
//
//////////////////////////////////////////////////////////////////////

#if !defined(SUPERCONE_SCREEN__INCLUDED_)
#define SUPERCONE_SCREEN__INCLUDED_
...
class SuperConeScreen : public GeomScreen
{
public:
    SuperConeScreen( ScreenMgr* mgr );
    virtual ~SuperConeScreen()                            {}
...
protected:
    ...
    SliderAdjRangeInput m_SuperConeDistanceSlider;
...
#endif // !defined(SUPERCONE_SCREEN__INCLUDED_)
