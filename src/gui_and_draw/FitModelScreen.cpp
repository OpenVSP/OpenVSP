...
FitModelScreen::FitModelScreen( ScreenMgr* mgr ) : TabScreen( mgr, 500, 469 + 107, "Fit Model", "", 107 )
{
    m_NVarLast = 0;
...
bool FitModelScreen::Update()
{
    ...
    int v_pos = m_TargetPtBrowser->vposition();
    ...
    m_TargetPtBrowser->vposition( v_pos );
