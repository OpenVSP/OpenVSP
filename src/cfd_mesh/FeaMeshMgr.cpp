...
void FeaMeshMgrSingleton::LoadDrawObjs( vector< DrawObj* > &draw_obj_vec )
{
    ...
    if ( !GetFeaMeshInProgress() && ( m_DrawElementFlagVec.size() == m_NumFeaParts + m_NumFeaSubSurfs ) )
    {
        ...
        for ( int cnt = 0; cnt <  m_NumFeaParts; cnt++ )
        {
            ...
            m_TriOrientationDO[cnt].m_Visible =
        ...
        for ( unsigned int i = 0; i < m_NumFeaSubSurfs; i++ )
        {
            ...
            m_SSTriOrientationDO[i].m_Visible =
...
void FeaMeshAnalysis::SetDefaults()
{
    ...
    if ( curr_struct )
    {
        ...
        m_Inputs.Add( NameValData( "GrowthRation", curr_struct->GetFeaGridDensityPtr()->m_GrowRatio() ) );
        m_Inputs.Add( NameValData( "RelCurveTol", curr_struct->GetStructSettingsPtr()->m_RelCurveTol() ) );
        m_Inputs.Add( NameValData( "STEPTolSlider", curr_struct->GetStructSettingsPtr()->m_STEPTol() ) );

         //Input Triggers
        m_Inputs.Add( NameValData( "Rig3dGrowthLimit", curr_struct->GetFeaGridDensityPtr()->m_RigorLimit() ) );
        m_Inputs.Add( NameValData( "ExportRaw", curr_struct->GetStructSettingsPtr()->m_ExportRawFlag() ) );
        ...
        m_Inputs.Add( NameValData( "LabelIDToggle", curr_struct->GetStructSettingsPtr()->m_CADLabelID() ) );
        m_Inputs.Add( NameValData( "LabelNameToggle", curr_struct->GetStructSettingsPtr()->m_CADLabelName() ) );
        m_Inputs.Add( NameValData( "LabelSurfNoToggle", curr_struct->GetStructSettingsPtr()->m_CADLabelSurfNo() ) );
        m_Inputs.Add( NameValData( "LabelSplitNoToggle", curr_struct->GetStructSettingsPtr()->m_CADLabelSplitNo() ) );
        m_Inputs.Add( NameValData( "STEPRepGroup", curr_struct->GetStructSettingsPtr()->m_STEPRepresentation() ) );

        //Input DropDowns
        m_Inputs.Add( NameValData( "LenUnitChoice", curr_struct->GetStructSettingsPtr()->m_CADLenUnit() ) );
        m_Inputs.Add( NameValData( "LabelDelimChoice", curr_struct->GetStructSettingsPtr()->m_CADLabelDelim() ) );
    ...
    else 
    {
        ...
        m_Inputs.Add( NameValData( "GrowthRation", temp_density.m_GrowRatio() ) );
        m_Inputs.Add( NameValData( "RelCurveTol", temp_settings.m_RelCurveTol() ) );
        m_Inputs.Add( NameValData( "STEPTolSlider", temp_settings.m_STEPTol() ) );

         //Input Triggers
        m_Inputs.Add( NameValData( "Rig3dGrowthLimit", temp_density.m_RigorLimit() ) );
        m_Inputs.Add( NameValData( "ExportRaw", temp_settings.m_ExportRawFlag() ) );
        ...
        m_Inputs.Add( NameValData( "LabelIDToggle", temp_settings.m_CADLabelID() ) );
        m_Inputs.Add( NameValData( "LabelNameToggle", temp_settings.m_CADLabelName() ) );
        m_Inputs.Add( NameValData( "LabelSurfNoToggle", temp_settings.m_CADLabelSurfNo() ) );
        m_Inputs.Add( NameValData( "LabelSplitNoToggle", temp_settings.m_CADLabelSplitNo() ) );
        m_Inputs.Add( NameValData( "STEPRepGroup", temp_settings.m_STEPRepresentation() ) );

        //Input DropDowns
        m_Inputs.Add( NameValData( "LenUnitChoice", temp_settings.m_CADLenUnit() ) );
        m_Inputs.Add( NameValData( "LabelDelimChoice", temp_settings.m_CADLabelDelim() ) );
...
string FeaMeshAnalysis::Execute()
{
    ...
    if ( curr_struct )
    {
        ...
        nvd = m_Inputs.FindPtr( "STEPTolSlider", 0 );
        ...
        nvd = m_Inputs.FindPtr( "ExportRaw", 0 );
        ...
        nvd = m_Inputs.FindPtr( "LabelIDToggle", 0 );
        ...
        nvd = m_Inputs.FindPtr( "LabelNameToggle", 0 );
        ...
        nvd = m_Inputs.FindPtr( "LabelSurfNoToggle", 0 );
        ...
        nvd = m_Inputs.FindPtr( "LabelSplitNoToggle", 0 );
        ...
        nvd = m_Inputs.FindPtr( "STEPRepGroup", 0 );
        ...
        nvd = m_Inputs.FindPtr( "LenUnitChoice", 0 );
        ...
        nvd = m_Inputs.FindPtr( "LabelDelimChoice", 0 );
    ...
    {
        printf( " Error - Cannot find a Structure: string FeaMeshAnalysis::Execute()\n " );
    }
