...
#else
static_assert( std::is_nothrow_move_constructible< VspCurve >::value, "VspCurve must be nothrow move constructible" );
static_assert( std::is_nothrow_move_assignable< VspCurve >::value, "VspCurve must be nothrow move assignable" );
#endif
